...
public class AttEdgeDelegate implements AttEdge {

    @Getter
    private final AttEdge impl;
    private final UncheckedSupplier<Object> getValue;

    public AttEdgeDelegate(AttEdge impl) {
        this.impl = impl;
        this.getValue = null;
    }

    public AttEdgeDelegate(AttEdge impl, UncheckedSupplier<Object> getValue) {
        this.impl = impl;
